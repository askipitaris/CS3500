...
public interface AnimatorModel {
   ...
   * startTick and endTick. DeltaX and DeltaY are determined by the difference between the start and
   * end divided by the number of tick the movement will occur over.
   *
