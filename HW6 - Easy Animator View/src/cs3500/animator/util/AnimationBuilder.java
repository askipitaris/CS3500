...
/**
 * An interface representing the AnimationBuilder.
 */
public interface AnimationBuilder<Doc> {
   ...
   *
   * @param name of the shape to be added. No shape with this name should already exist.
   * @param type type of shape (e.g. "ellipse", "rectangle") to be added.
   * @return This {@link AnimationBuilder}
   */
